...
void Customer::copy(const Customer& other)
{
    ...
    this->entersQueue = other.entersQueue;
    this->entersTill = other.entersTill;
}
...
void Customer::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->entersQueue);
    doParsimPacking(b,this->entersTill);
}
...
void Customer::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->entersQueue);
    doParsimUnpacking(b,this->entersTill);
}
...
::omnetpp::simtime_t Customer::getEntersQueue() const
{
    return this->entersQueue;
}

void Customer::setEntersQueue(::omnetpp::simtime_t entersQueue)
{
    this->entersQueue = entersQueue;
}

::omnetpp::simtime_t Customer::getEntersTill() const
{
    return this->entersTill;
}

void Customer::setEntersTill(::omnetpp::simtime_t entersTill)
{
    this->entersTill = entersTill;
}
...
int CustomerDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='e' && strcmp(fieldName, "entersQueue")==0) return base+2;
    if (fieldName[0]=='e' && strcmp(fieldName, "entersTill")==0) return base+3;
...
std::string CustomerDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return simtime2string(pp->getEntersQueue());
        case 3: return simtime2string(pp->getEntersTill());
        default: return "";
    }
}
...
bool CustomerDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setEntersQueue(string2simtime(value)); return true;
        case 3: pp->setEntersTill(string2simtime(value)); return true;
